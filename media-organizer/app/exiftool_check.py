...
def get_exiftool_path():
    """Return the path to the bundled exiftool.exe if running as a bundled app, else look in ExifTool folder."""
    if getattr(sys, 'frozen', False):
        # PyInstaller bundle: exiftool.exe is next to the executable
