...
class MediaOrganizerController:
    ...
    def run_organizer(self, source, dest, operation, dry_run, tag_order=None, max_workers=4, eta_callback=None, formats=None):
        self.cancel_flag = False
        ...
        def organize_one(file_path):
            ...
            organize_files([file_path], dest, operation, dry_run=dry_run, tag_order=tag_order)
